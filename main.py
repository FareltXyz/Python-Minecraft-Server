...
if argumen == "--start":
 ...
 if not os.path.exists("bedrock") :
  ...
  subprocess.run(["cd bedrock && ./bedrock_server"], env=envss, shell=True)
  ...
  while flag:
    ...
    if mcsvrmenu.isdigit():
        ...
        if pilihan == 1:
                ...
                while flag:
                   print("====================°    °======================")
                   print(f"| select server version     ip: {socket.gethostbyname(socket.gethostname())}")
                   print("|")
                   ...
                   if svrvrch.isdigit():
                           ...
                           if subver == 1:
                                while flag:   
                                   ...
                                   if input20.isdigit():
                                           ...
                                           if sub20 == 1:
                                                 os.system("clear")
                                                 while flag:
                                                   print("Are You Sure Want to Install")
                                                   ...
                                                   if yn15 == "yes" :
                                                        ...
                                                        with open('data-data.json', 'r') as file:
                                                         ...
                                                         linxurl = urll.replace("bin-win", "bin-linux")
                                                         
                                                         try:
                                                                 print("downloading assest....")
                                                                 urllib.request.urlretrieve(linxurl, filenamed)
                                                                 print("download success")
                                                         except Exception as e:
                                                                 print(f"err: {str(e)}")
                                                         folname = filenamed.replace(".zip", " ")
                                                         time.sleep(5)
                                                         print("extracting....")
                                                         ...
                                                         with zipfile.ZipFile(filenamed, "r") as zip_ref:
                                                                 ...
                                                                 time.sleep(5)
                                                                 svrip = socket.gethostbyname(socket.gethostname())
                                                                 print("Running...")
                                                                 print(f"Running in ip: {svrip}")
                                                                 time.sleep(5)
                                                                 os.system("clear")
                                                                 envs = {"LD_LIBRARY_PATH": "."}
                                                                 subprocess.run(["chmod +x ./bedrock/bedrock_server"], shell=True)
                                                                 subprocess.run(["cd bedrock && ./bedrock_server"], env=envs, shell=True)
                                                   elif yn15 == "no" :
                                                        os.system("clear")
                                                        break
                                                        print("Canceled")
                                                ...
                                                os.system("clear")
                                                while flag:
                                                        print("Are You Sure to Install/Change version")
                                                        print("1.20.1??")
                                                        yn1201 = input("[yes/no]")
                                                        if yn1201 == "yes":
                                                            flag = False
                                   ...
                                   while flag:
                                    ...
                                    if sub19.isdigit():
                                      ...
                                      if subv19 == 1:
                                        ...
                                        while flag:
                                              os.system("clear")
                                              print("Are you sure install/change version to")
                             ...
                             while flag:
                                print("====================°    °======================")
                                print(f"| Select a Versions     ip: {socket.gethostbyname(socket.gethostname())}")
                                print("| ")
                                print("|")
                                print("| 1. 1.18.33")
                                print("| 2. 1.18.32")
                            ...
                            while flag:
                              print("====================°    °======================")
                              print(f"| select version         ip: {socket.gethostbyname(socket.gethostname())}")
                              print("|")
                              print("| [1] 1.17.41                           [0] Back")
                              print("| [2] 1.17.33")
                              print("| [3] 1.17.31")
                              print("| [4] 1.17.11")
                              ...
                              if subver17.isdigit():
                                ...
                                while flag:
                                   ...
                                   if not os.path.exists("bedrock"):
                                    ...
                                    subprocess.run(["chmod +x ./bedrock/bedrock_server"], shell=True)
                                    subprocess.run(["cd bedrock && ./bedrock_server"], env=envs9, shell=True)
                           elif subver == 0:
                                   os.system("clear")
                                   print("back")
                                   break
